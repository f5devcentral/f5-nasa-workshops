...
1. Let's create a new project, in the main left tab go to **Projects** ⇒ Select **CalypsoAI chat** ⇒ **Create** ⇒ Set **Chat name** to **Test project** ⇒ **Create**
   ...
   You can see that the global level guardrails have been added automatically to the project.
   
2. If we want, we can add more guardrails by clicking **Add guardrails** or modify existing ones.
